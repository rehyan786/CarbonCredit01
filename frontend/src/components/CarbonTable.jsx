...
const CarbonTable = ({ data, searchTerm }) => {
  ...
  const infoBlocks = [
    ...
    {
      title: "European Carbon Credit Market",
      content: (
        <>
          <p className='abcd'>
    ...
    {
      title: "Nature Based Carbon Offset",
      content: (
        <p className='abcd'>
    ...
    {
      title: "Aviation Industry Carbon Offset",
      content: (
        <p className='abcd'>
    ...
    {
      title: "Tech Industry Carbon Offset",
      content: (
        <p className='abcd'>
    ...
    },
    {
      ...
      content: (
        <p className='abcd'>
          The UK ETS was launched in 2021 after Brexit, which replaced the UK’s participation in the EU ETS. Prices broadly align with the EU ETS but operates independently. It is a key policy tool to reach the UK’s legally binding net-zero target by 2050.
        </p>
      )
    },
  ];

  const visibleBlocks = showMore ? infoBlocks : infoBlocks.slice(0, 4);
